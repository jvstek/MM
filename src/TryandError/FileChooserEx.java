...
//no use for it ..... cause people make mistakes
public class FileChooserEx extends JFrame {
	...
	private void createLayout(JComponent... arg) {
		...
		gl.setHorizontalGroup(gl.createParallelGroup().addComponent(arg[0], DEFAULT_SIZE, DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(gl.createSequentialGroup().addComponent(arg[1])));

		gl.setVerticalGroup(gl.createSequentialGroup().addComponent(arg[0]).addGap(4).addComponent(arg[1]));
	...
	public String readFile(File file) {
		...
		try {
			...
			Logger.getLogger(FileChooserEx.class.getName()).log(Level.SEVERE, null, ex);
		}
